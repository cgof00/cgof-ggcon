...
export function EmendasDataTable({
  ...
  const columnDefinitions: ColumnDef[] = [
    ...
    { key: 'data_ult_e', label: 'Data Últ. Tramitação Emenda', render: (e) => formatDate(e.data_ult_e || '') },
    { key: 'data_ult_d', label: 'Data Últ. Tramitação Demanda', render: (e) => formatDate(e.data_ult_d || '') },
    { key: 'num_indicacao', label: 'Nº da Indicação', render: (e) => e.num_indicacao || '—' },
